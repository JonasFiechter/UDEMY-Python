...
Você também pode utilizar a função monthrange de calendar para pegar o número do dia na semana (entre 0-6) e último dia
do mês (entre 28-31), exemplo:
...
formatacao_2 = dt.strftime('%d/%m/%Y %H:%M:%S')
print(formatacao)
print(formatacao_2)
print(mdays)
