"""
Builder é um padrão de criação que tem a intenção de separar a construção
de um objeto complexo da sua representação, de modo que o mesmo processo
...
class IUserBuilder(ABC):
    ...
    @abstractmethod
    def add_firstname(self, name): pass

    @abstractmethod
    def add_lastname(self, name): pass

    @abstractmethod
    def add_age(self, age): pass

    @abstractmethod
    def add_phone_number(self, phone): pass
...
if __name__ == '__main__':
    ...
    user_1 = user_director.with_age('Tomas', 'Tequinho', 23)
