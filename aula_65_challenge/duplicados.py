...
def encontra_duplicado(lista):
    ...
    for n in lista:
        ...
        for l in n:
            loop2 += 1
            if loop2 == 10:
                print(f'não há duplicados na lista; {loop1}')
                break
            if l not in list_temp:
                list_temp.append(l)
            else:
                print(f'Duplicado: {l}, na lista: {loop1}')
                break
...
def gerador(lista):
    for l in lista:
        print(encontra_duplicado2(l))

def encontra_duplicado2(lista):
        ...
        for l in lista:
            ...
            if l not in list_temp:
                ...
                numero_checado = l
                break
        return numero_checado

gerador(lista_de_listas_de_inteiros)
